...
PasswordsClientFactory.HttpClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor('service-passwords', 'client', 'http', 'default', '1.0');
PasswordsClientFactory.LambdaClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor('service-passwords', 'client', 'lambda', 'default', '1.0');
